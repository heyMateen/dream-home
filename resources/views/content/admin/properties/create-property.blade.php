        ...
        <div class="row">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="card-header">Add Property</h3>
                </div>
                <div class="mt-2 mb-2">
                            ...
                            <form method="POST" action="{{ route('admin.properties.store') }}">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"
                                        placeholder="Beautiful Apartment in City Center" value="{{ old('title') }}" />
                                    @error('title')
                                        <div class="alert alert-danger mt-2 mb-1 text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="4"
                                        placeholder="Write a brief description of the property">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="alert alert-danger mt-2 mb-1 text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="number" class="form-control" name="price" id="price"
                                        placeholder="1000000" value="{{ old('price') }}" min="0" />
                                    @error('price')
                                        <div class="alert alert-danger mt-2 mb-1 text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="form-check">
                                        <input name="status" class="form-check-input" type="radio" value="sold"
                                            id="sold" {{ old('status') == 'sold' ? 'checked' : '' }} />
