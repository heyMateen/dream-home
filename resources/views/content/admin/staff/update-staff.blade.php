...
@section('title', 'Update Staff | ' . $staff->user->first_name . ' ' . $staff->user->last_name)
        ...
        <div class="row">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="card-header">Update Staff</h3>
                </div>
                <div class="mt-2 mb-2">
                ...
                <div class="col-xl card-body">
                    <div class="mb-6">
                        <form method="POST" action="{{ route('admin.staff.update', ['staff_id' => $staff->id]) }}">
                            @csrf
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <select class="form-select" id="role" name="role">
                                    ...
                                    <option value="employee"
                                        {{ old('role', $staff->role) == 'employee' ? 'selected' : '' }}>Employee</option>
                                </select>
                                @error('role')
                                    <div class="alert alert-danger mt-2 mb-1 text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md">
                                ...
                                <div class="form-check">
                                    <input name="status" class="form-check-input" type="radio" value="inactive"
                                        id="inactive"
                                        {{ old('status', $staff->status == '0' ? 'inactive' : '') == 'inactive' ? 'checked' : '' }} />
