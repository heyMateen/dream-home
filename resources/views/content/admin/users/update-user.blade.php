                            ...
                            <form method="POST" action="{{ route('admin.users.update', ['user_id' => $user->id]) }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" name="address" id="address"
                                        placeholder="123 Main Street" value="{{ old('address', $user->address) }}" />
                                    @error('address')
                                        <div class="alert alert-danger mt-2 mb-1 text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select class="form-select" id="role" name="role">
                                        ...
                                        <option value="owner" {{ old('role', $user->role) == 'owner' ? 'selected' : '' }}>
                                            Owner</option>
                                        <option value="client"
                                            {{ old('role', $user->role) == 'client' ? 'selected' : '' }}>Client</option>
                                        <option value="staff"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div id="imagePreviewContainer" class="mt-2">
                                        @if ($user->profile_image)
                                            <img id="imagePreview" src="{{ $user->profile_image }}" alt="Profile Image"
                                                class="img-fluid"
                                                style="width: 150px; height: 120px; margin-top:10px; border-radius:8px;">
                                        @else
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check">
                                        <input name="status" class="form-check-input" type="radio" value="inactive"
                                            id="inactiveRadio"
                                            {{ old('status', $user->status == '0' ? 'inactive' : '') == 'inactive' ? 'checked' : '' }} />
